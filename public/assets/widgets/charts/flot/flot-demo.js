...
$(function() {
    ...
    var dataSet = [
        {label: "Workshop", data: 1119630000, color: getUIColor('info') },
        { label: "Seminar", data: 690950000, color: getUIColor('warning') },
        { label: "Sertifikasi", data: 1012960000, color: getUIColor('danger') },
        { label: "Lokakarya", data: 51000000, color: getUIColor('gray') }
        //{ label: "Europe", data: 727080000, color: getUIColor('primary') },
        //{ label: "North America", data: 344120000, color: getUIColor('success') }
    ];
	
	var dataSet1 = [
        {label: "Bussiness Academy", data: 1119630000, color: getUIColor('gray') },
        { label: "Competency School", data: 690950000, color: getUIColor('primary') },
        { label: "Other", data: 1012960000, color: getUIColor('success') }
        //{ label: "Lokakarya", data: 51000000, color: getUIColor('gray') }
        //{ label: "Europe", data: 727080000, color: getUIColor('primary') },
        //{ label: "North America", data: 344120000, color: getUIColor('success') }
    ];
	...
	var dataSet2 = [
        {label: "CCT", data: 1119630000, color: getUIColor('info') },
        { label: "OT", data: 690950000, color: getUIColor('warning') },
        { label: "OJT", data: 1012960000, color: getUIColor('danger') },
        { label: "ST", data: 51000000, color: getUIColor('gray') },
        { label: "HCT", data: 727080000, color: getUIColor('primary') },
        { label: "CT", data: 344120000, color: getUIColor('success') }
    ];
