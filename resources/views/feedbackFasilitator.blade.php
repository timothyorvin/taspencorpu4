...
<div id="page-title">
<p>Beranda > Event > Input Feedback Fasilitator</p>
    <br>
...
<div class="input-group">
                <div class="input-group-addon">
                  ...
                  <p style="width:250px;"><b>Feedback Fasilitator</b></p>
                </div>
                <form action='/feedbackDone/{{$id}}/{{$id1}}' method='GET'>
                <input type="text" class="form-control pull-right" name="feedback_fasilitator" id="feedback_fasilitator">
              </div>
