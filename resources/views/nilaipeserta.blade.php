...
<div id="page-title">
<p><a href="{{url('/welcome')}}">Beranda</a> > <a href="{{url('/event')}}">Event</a> > Input Nilai Peserta</p>
    <br>
    <h2>Input Nilai Peserta</h2>
</div>
...
<form action='/nilaiDone/{{$id}}/{{$id1}}' method='GET'>

<div class="input-group">
                <div class="input-group-addon">
                  <!-- <i class="fa fa-calendar"></i> -->
                  <p style="width:250px;"><b>Nilai Peserta</b></p>
                </div>
                
                <input type="text" class="form-control pull-right" name='nilai_peserta'>
              </div>
