...
<div id="page-title">
    <p>Beranda > Master Data > Bentuk Pelatihan</p>
    <br>
    <h2>Bentuk Pelatihan & Pendidikan</h2>
</div>
...
<tr>
    <th>No</th>
    <th>Bentuk Pelatihan / Pendidikan</th>
	<th>Aksi</th>
</tr>
</thead>
...
@foreach($bentuk as $b)
<tr>
    <td>{{$b->IDBentukPelatihan}}</td>
    <td>{{$b->BentukPelatihan}}</td>
    <td>
    <form action='/editBentuk/{{$b->IDBentukPelatihan}}' method='GET'>
    <input type="hidden" name="bentuk_pendidikan" id="bentuk_pendidikan" value="{{$b->BentukPelatihan}}">
    <button type="submit" class="bt_edit" title="Edit" id="btn_edit"><i class="fa fa-edit"></i></button>
    </form>
    <form action='/deleteBentuk' method='POST'>
    <input type="hidden" name="hapus" value="{{$b->IDBentukPelatihan}}">
...
<div id="myAdd" class="modal">
    <div class="modal-content">
                  <span class="close">&times;</span>
                    <h3>Tambah Bentuk Pendidikan</h3>
                    <br>
                    <div class="input-group">
                <div class="input-group-addon">
                  <!-- <i class="fa fa-calendar"></i> -->
                  <p style="width:250px;"><b>Bentuk Pendidikan</b></p>
                </div>
                <input type="text" class="form-control pull-right" placeholder="Bentuk Pendidikan" name="bentuk_pendidikan" id="bentuk_pendidikan1">
              </div>
...
btn_date.onclick = function() { 
    var bentuk_pendidikan = $("#bentuk_pendidikan1").val();
    
    
    $.ajax({
      type: "GET",
      url: "{{url('tambahBentuk/api')}}",
...
<script type="text/javascript">
  var temp = $("#temp").val();
  var t = 'myEdit'+temp;
  var modal_edit = document.getElementById(t);
  var temp1 = $("#temp1").val();
  var t2 = 'btn_edit'+temp1;
  
  var btn_edit = document.getElementById(t2);
...
<script type="text/javascript">
var temp = $("#temp").val();
var t = 'btn_date2'+temp;
var btn_date = document.getElementById(t);
