...
<div id="page-title">
    <p>Beranda > Master Data > Kategori Pelatihan > Edit</p>
    <br>
    <h2>Edit Kategori Pendidikan</h2>
</div>
...
<div class="input-group">
                ...
                <form action='/editKatDone/{{$id}}' method='GET'>
                <input type="text" class="form-control pull-right" name="kategori_pendidikan" id="kategori_pendidikan" value="{{$kategori_pendidikan}}">
              </div>
