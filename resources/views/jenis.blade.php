...
<div id="page-title">
    <p>Beranda > Master Data > Jenis Pelatihan</p>
    <br>
    <h2>Jenis Pelatihan & Pendidikan</h2>
</div>
...
<div class="size-md">
    <a class="btn btn-primary btn-md toggle-vis" id="btn_tambah" data-column="0">Tambah</a>
</div>
</br>
...
<tr>
    <td>{{$p->IDJenisPelatihan}}</td>
    <td>{{$p->JenisPelatihan}}</td>
    <td>{{$p->Singkatan}}</td>
    <td>
    <form action='/editJenis/{{$p->IDJenisPelatihan}}' method="GET">
    <input type="hidden" name="jenis_pendidikan" value="{{$p->JenisPelatihan}}">
    <input type="hidden" name="singkatan" value="{{$p->Singkatan}}">
    <button type="submit" class="bt_edit" title="Edit" id="btn_edit"><i class="fa fa-edit"></i></button>
    </form>
    <form action='/deleteJenis' method="post">
    <input type="hidden" name="hapus" value="{{$p->IDJenisPelatihan}}">
    <input type="hidden" name="_token" value="{{csrf_token()}}">
    <button type="submit" class="bt_hapus" title="Hapus" onclick='function(){alert("Sukses")};'><i class="fa fa-trash"></i></button>
    </form>
    </td>
</tr>
...
<div id="myAdd" class="modal">
    <div class="modal-content">
                  <span class="close">&times;</span>
                    <h3>Tambah Jenis Pendidikan</h3>
                    <br>
                    <form action='tambahJenis/api' method='GET'>
                    <div class="input-group">
                <div class="input-group-addon">
                  <!-- <i class="fa fa-calendar"></i> -->
                  <p style="width:250px;"><b>Jenis Pendidikan</b></p>
                </div>
                <input type="text" class="form-control pull-right" placeholder="Jenis Pendidikan" name="jenis_pendidikan1" id="jenis_pendidikan1">
              </div>

              <div class="input-group">
                <div class="input-group-addon">
                  <!-- <i class="fa fa-calendar"></i> -->
                  <p style="width:250px;"><b>Singkatan</b></p>
                </div>
                <input type="text" class="form-control pull-right" placeholder="Singkatan" name="singkatan1" id="singkatan1">
              </div>
             ...
             <div class="input-group">
              ...
              <button type='submit' class="btn btn-primary center-block" name="btn_date1" id="btn_date1">Simpan</a>
...
<!-- <script type="text/javascript">
  ...
  var val = $(".edt_jenis").val();
  var btn_edit = document.getElementById("btn_edit"+val);
...
btn_date.onclick = function() { 
    var jenis_pendidikan = $("#jenis_pendidikan1").val();
    var singkatan = $("#singkatan").val();
    
    $.ajax({
      type: "GET",
      url: "{{url('tambahJenis/api')}}",
