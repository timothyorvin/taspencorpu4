...
<div id="page-title">
    <p>Beranda > Master Data > Katalog Pelatihan > Edit</p>
    <br>
    <h2>Edit Katalog Pendidikan</h2>
</div>
...
<form action='/editKatlDone/{{$id}}' method="GET">
<div class='input-group'>
                <div class="input-group-addon">
                  <!-- <i class="fa fa-calendar"></i> -->
                  <p style="width:250px;"><b>Nama Pelatihan</b></p>
                </div>
                <input type="text" class="form-control pull-right" placeholder="Nama Pelatihan" name="katalog_pendidikan" value="{{$katalog_pendidikan}}">
              </div>
              ...
              <div class="input-group">
                ...
                <select class="form-control pull-right" placeholder="Jenis" name="jenis_pendidikan" value="{{$jenis_pendidikan}}">
                    @foreach($jenis as $j)
              ...
              <div class="input-group">
                ...
                <select class="form-control pull-right" placeholder="Bentuk" autocomplete="off" name="bentuk_pendidikan" value="{{$bentuk_pendidikan}}">
              ...
              <div class="input-group">
                <div class="input-group-addon">
                  ...
                  <select class="form-control pull-right" name="kategori_pendidikan" placeholder="Kategori" value="{{$kategori_pendidikan}}">
             ...
             <div class="input-group">
              ...
              <button class="btn btn-primary center-block" name="btn_date2" id="btn_date2">Simpan</button>
