...
<div id="page-title">
    <p>Beranda > Katalog Pelatihan</p>
    <br>
    <h2>Katalog Pelatihan & Pendidikan</h2>
</div>    
...
<tr>
    <td>{{$kt->IDPelatihan}}</td>
    <td>{{$kt->NamaKatalog}}</td>
    <td>{{$kt->JenisPelatihan}}</td>
	<td>{{$kt->BentukPelatihan}}</td>
	<td>{{$kt->KategoriPelatihan}}</td>
    <td>
    <form action='/editKatalog/{{$kt->IDPelatihan}}'>
    <input type="hidden" name="bentuk_pendidikan" value="{{$kt->BentukPelatihan}}">
    <input type="hidden" name="katalog_pendidikan" value="{{$kt->NamaKatalog}}">
    <input type="hidden" name="jenis_pendidikan" value="{{$kt->JenisPelatihan}}">
    <input type="hidden" name="kategori_pendidikan" value="{{$kt->KategoriPelatihan}}">
    <button type="submit" class="bt_edit" title="Edit" id="btn_edit"><i class="fa fa-edit"></i></button>
    </form>
    <form action='/deleteKatalog' method='POST'>
    <input type="hidden" name="hapus" value="{{$kt->IDPelatihan}}">
    <input type="hidden" name="_token" value="{{csrf_token()}}">
    <button class="bt_hapus" title="Hapus"><i class="fa fa-trash"></i></button>
    </form>
    </td>
</tr>
@endforeach
...
<div id="myAdd" class="modal">
  <div class="modal-content"  style="margin-top: 5%;">
    <span class="close">&times;</span>
      <h3>Tambah Katalog Pelatihan</h3>
      <br>
      <div class="form-group">     
              <div class="input-group">
                <div class="input-group-addon">
                  <!-- <i class="fa fa-calendar"></i> -->
                  <p style="width:250px;"><b>Nama Katalog Pelatihan</b></p>
                </div>
                <input type="text" class="form-control pull-right" placeholder="Katalog Pelatihan" name="katalog_pendidikan" id="katalog_pendidikan"></select>
              </div>

              <div class="input-group">
                <div class="input-group-addon">
                  <!-- <i class="fa fa-calendar"></i> -->
                  <p style="width:250px;"><b>Jenis</b></p>
                </div>
                <select class="form-control pull-right" placeholder="Jenis" name="jenis_pendidikan" id="jenis_pendidikan" >
                    <option>-Pilih Jenis Pendidikan-</option>
                    @foreach($jenis as $j)
                    <option>{{$j->JenisPelatihan}}</option>
                    @endforeach
                </select>
              </div>
              ...
              <div class="input-group">
                <div class="input-group-addon">
                  <!-- <i class="fa fa-calendar"></i> -->
                  <p style="width:250px;"><b>Bentuk</b></p>
                </div>
                <select class="form-control pull-right" placeholder="Bentuk" autocomplete="off" name="bentuk_pendidikan" id="bentuk_pendidikan">
                    <option>-Pilih Bentuk Pendidikan-</option>
                    @foreach($bentuk as $b)
                    <option>{{$b->BentukPelatihan}}</option>
					@endforeach
                </select>
              </div>
              ...
              <div class="input-group">
                <div class="input-group-addon">
                  <!-- <i class="fa fa-calendar"></i> -->
                  <p style="width:250px;"><b>Kategori</b></p>
                  </div>
                  <select class="form-control pull-right" name="kategori_pendidikan" placeholder="Kategori" id="kategori_pendidikan">
                      <option>-Pilih Kategori Pendidikan-</option>
                    @foreach($kategori as $k)
                    <option>{{$k->KategoriPelatihan}}</option>
					@endforeach
                  </select>
                </div>
             ...
             <div class="input-group">
			  ...
			  <button class="btn btn-danger center-block" name="btn_cancel" id="btn_cancel">Batal</button>
            </div>
      </div>
    </div>
  </div>
...
btn_date.onclick = function() { 
    ...
    var bentuk_pendidikan = $("#bentuk_pendidikan").val();
    var jenis_pendidikan = $("#jenis_pendidikan").val();
    var kategori_pendidikan = $("#kategori_pendidikan").val();
    $.ajax({
      type: "GET",
      url: "{{url('tambahKatalog/api')}}",
      data: {'bentuk_pendidikan':bentuk_pendidikan,
      'katalog_pendidikan':katalog_pendidikan,
      'jenis_pendidikan':jenis_pendidikan,
      'kategori_pendidikan':kategori_pendidikan
      },
