...
<link rel="stylesheet" type="text/css" href="assets/helpers/admin-responsive.css">
    ...
    <div id="mobile-navigation">
        ...
        <a href="welcome" class="logo-content-small" title="MonarchUI"></a>
    </div>
    <div id="header-logo" class="logo-bg">
        <a href="welcome" class="logo-content-big" title="MonarchUI">
            Taspen Corpu <i>UI</i>
        </a>
        <a href="welcome" class="logo-content-small" title="MonarchUI">
             Taspen Corpu <i>UI</i>
            <span></span>
        </a>
    ...
    <div id="header-nav-right">
        ...
        <a class="header-btn" id="logout-btn" href="lockscreen" title="Lockscreen page example">
