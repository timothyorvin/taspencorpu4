...
<div id="page-title">
    ...
    <p>Sistem Informasi Taspen Corpu</p>
</div>
    ...
    <span class="close">&times;</span>
      ...
      <div class="form-group">     
              <div class="input-group">
                ...
                <input type="text" class="form-control pull-right" placeholder="Nama Pelatihan" name="nama_pelatihan"></select>
              </div>
              ...
              <div class="input-group">
                ...
                <select class="form-control pull-right" placeholder="Jenis" name="jenis_pendidikan">
              ...
              <div class="input-group">
                ...
                <select class="form-control pull-right" placeholder="Bentuk" autocomplete="off" name="bentuk_pendidikan">
                    <option>-Pilih Bentuk Pendidikan-</option>
                    <option>Bentuk 1</option>
              ...
              <div class="input-group">
                <div class="input-group-addon">
                  ...
                  <select class="form-control pull-right" name="kategori" placeholder="Kategori">
             ...
             <div class="input-group">
              ...
              <button class="btn btn-primary center-block" name="btn_date" id="btn_date">Tambah</button>
            </div>
      </div>
    </div>
  </div>
    ...
    <span class="close_edit">&times;</span>
      ...
      <div class="form-group">     
             ...
             <div class="input-group">
              ...
              <button class="btn btn-primary center-block" name="btn_date" id="btn_date">Edit</button>
            </div>
      </div>
    </div>
  </div>
