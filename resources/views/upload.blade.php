...
<div id="page-title">
<p><a href="{{url('/welcome')}}">Beranda</a> > <a href="{{url('/event')}}">Event</a> > Materi Pelatihan</p>
    <br>
    <h2>Upload Materi</h2>
</div>
...
<input type="submit" class="btn btn-primary center-block" value="Upload"><br>
</form>
</div>
</div>
@endif
...
@foreach($materi as $m)
<i class="fa file-word"></i><a href="{{'E:/'.$m->LinkMateri}}">{{$m->LinkMateri}}</a>
<br>
@endforeach
</div>
</div>
