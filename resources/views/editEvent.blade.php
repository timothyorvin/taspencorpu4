...
<div id="page-title">
<p><a href="{{url('/welcome')}}">Beranda</a> > <a href="{{url('/event')}}">Event</a> > Edit</p>
    <br>
    <h2>Edit Jenis Pendidikan</h2>
</div>
...
<form action='/editEventDone/{{$id}}' method="GET">
<div class="form-group">   
        ...
        <div class="input-group">
                ...
                <input type="text" name="event_pelatihan" id="event_pelatihan" class="form-control pull-right" value="{{$event_pelatihan}}">
            </div>  
            ...
            <div class="input-group">
              ...
              <div class="input-group">
                ...
                <input type="date" class="form-control pull-right" name="date_start" id="date_start" placeholder="Tanggal mulai" autocomplete="off" value={{$date_start}}>
              </div>
              ...
              <div class="input-group">
                <div class="input-group-addon">
                  ...
                  <input type="date" class="form-control pull-right" name="date_end" id="date_end" placeholder="Tanggal berakhir" autocomplete="off" value="{{$date_end}}">
                </div>
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control pull-right" placeholder="Provider" name="provider" id="provider" value="{{$provider}}">
              </div>
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control pull-right" placeholder="Tempat" name="tempat" id="tempat" value="{{$tempat}}">
              </div>
              <div class="input-group">
                <div class="input-group-addon">
                  <!-- <i class="fa fa-calendar"></i> -->
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control pull-right" placeholder="IO Budgeting" name="IOBudgeting" id="IOBudgeting" value="{{$iobudgeting}}">
              </div>
              <div class="input-group">
                <div class="input-group-addon">
                  <!-- <i class="fa fa-calendar"></i> -->
                ...
                <input type="text" class="form-control pull-right" placeholder="Biaya pendidikan" name="biaya_pendidikan" id="biaya_pendidikan" value="{{$biaya_pendidikan}}">
              </div>
