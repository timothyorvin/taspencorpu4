...
<div id="page-title">
    <p>Beranda > Master Data > Kategori Pelatihan</p>
    <br>
    <h2>Kategori Pelatihan & Pendidikan</h2>
</div>
...
<tr>
    <th>No</th>
    <th>Kategori Pelatihan / Pendidikan</th>
	<th>Aksi</th>
</tr>
</thead>
...
<tr>
    <td>{{$k->IDKategoriPelatihan}}</td>
    <td>{{$k->KategoriPelatihan}}</td>
    <td>
    <form action='/editKategori/{{$k->IDKategoriPelatihan}}' method='GET'>
    <input type="hidden" name="kategori_pendidikan" value="{{$k->KategoriPelatihan}}">
    ...
    <input type="hidden" name="hapus" value="{{$k->IDKategoriPelatihan}}">
...
<div id="myAdd" class="modal">
    <div class="modal-content">
                  <span class="close">&times;</span>
                    <h3>Tambah Kategori Pendidikan</h3>
                    <br>
                    <div class="input-group">
                <div class="input-group-addon">
                  <!-- <i class="fa fa-calendar"></i> -->
                  <p style="width:250px;"><b>Kategori Pendidikan</b></p>
                </div>
                <input type="text" class="form-control pull-right" placeholder="Kategori Pendidikan" name="kategori_pendidikan" id="kategori_pendidikan1">
              </div>
...
btn_date.onclick = function() { 
    var kategori_pendidikan = $("#kategori_pendidikan1").val();
    
    
    $.ajax({
      type: "GET",
      url: "{{url('tambahKategori/api')}}",
      data: {'kategori_pendidikan':kategori_pendidikan},
