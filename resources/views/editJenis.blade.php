...
<div id="page-title">
    <p>Beranda > Master Data > Jenis Pelatihan > Edit</p>
    <br>
...
<div class="input-group">
                ...
                <form action='/editJenDone/{{$id}}' method='GET'>
                <input type="text" class="form-control pull-right" name="jenis_pendidikan" id="jenis_pendidikan" value="{{$jenis_pendidikan}}">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control pull-right" name="singkatan" id="singkatan" value="{{$singkatan}}">
             ...
             <div class="input-group">
              ...
              <button type="submit" class="btn btn-primary center-block" name="btn_date2" id="btn_date2">Simpan</button>
