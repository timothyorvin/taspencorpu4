...
<div id="page-title">
    <p>Beranda > Master Data > Bentuk Pelatihan > Edit</p>
    <br>
    <h2>Edit Bentuk Pelatihan & Pendidikan</h2>
</div>
...
<div class="input-group">
                ...
                <form action='/editDone/{{$id}}' method='GET'>
                <input type="text" class="form-control pull-right" name="bentuk_pendidikan" id="bentuk_pendidikan" value="{{$bentuk_pendidikan}}">
              </div>
