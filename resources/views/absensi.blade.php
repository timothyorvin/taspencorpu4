...
<div id="page-title">
<p><a href="{{url('/welcome')}}">Beranda</a> > <a href="{{url('/event')}}">Event</a> > Absensi Peserta</p>
    <br>
    <h2>Absensi Peserta Pelatihan</h2>
</div>
...
<tr>
    ...
    <td>{{$d->Nama}}</td>
    <td>{{$d->Tanggal}}</td>
    <td><input type="checkbox" name="check_list[]" value="{{$d->Nama}}"></td>
</tr>
@endforeach
</tbody>
</table>
</div>
<button class="btn btn-primary center-block" onclick="window.location.href='/absensi2/{{$id}}'">Simpan</button>
</div>
</div>
